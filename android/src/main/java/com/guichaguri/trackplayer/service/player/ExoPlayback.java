 ...
 * @author Guichaguri
 */
public abstract class ExoPlayback<T extends Object> {
    ...
    protected int lastKnownWindow = 0; //C.INDEX_UNSET;
    protected long lastKnownPosition = 0; //C.POSITION_UNSET;
...
//        player.addListener(this);
    ...
    public void updateTrack(int index, Track track) {
        int currentIndex = index; //player.getCurrentWindowIndex();
    ...
    public Integer getCurrentTrackIndex() {
        int index = 0; //player.getCurrentWindowIndex();
    ...
    public void skip(int index, Promise promise) {
        ...
        lastKnownWindow = 0; // player.getCurrentWindowIndex();
        lastKnownPosition = 0;//player.getCurrentPosition();
...
//        player.seekToDefaultPosition(prev);
    ...
    public void skipToNext(Promise promise) {
        int next = 0; //player.getNextWindowIndex();
...
//        player.setPlayWhenReady(false);
    ...
    public long getBufferedPosition() {
        return 0; //player.getBufferedPosition();
    }
...
//        player.seekTo(time);
    ...
    public float getRate() {
        return 1.0f; //player.getPlaybackParameters().speed;
    }
